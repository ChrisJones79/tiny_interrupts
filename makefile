...
# Taken from electronut: Mahesh Venkitachalam
# and pared down to the bare minimum
...
DIRAVR = /home/chris/bin/avr8-gnu-toolchain-linux_x86_64
DIRAVRBIN = $(DIRAVR)/bin
DIRAVRUTILS = $(DIRAVR)/avr/include/util
